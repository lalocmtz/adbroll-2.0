...
serve(async (req) => {
  ...
  try {
    const { script, voiceId, projectId, settings } = await req.json();
    ...
    // Call ElevenLabs API with custom settings
    ...
    console.log("Voiceover generated successfully:", urlData.signedUrl);
